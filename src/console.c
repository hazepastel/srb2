...
consvar_t cons_backcolor = CVAR_INIT ("con_backcolor", "Steel", CV_CALL|CV_SAVE, backcolor_cons_t, CONS_backcolor_Change);
...
static void CON_DrawBackpic(void)
{
	...
	if (con_startup)
		y = (vid.height / 2) - ((con_backpic->height * vid.dup) / 2);
	else
