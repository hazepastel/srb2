...
consvar_t cv_scr_width_w = CVAR_INIT ("scr_width_w", "1280", CV_SAVE, CV_Unsigned, NULL);
consvar_t cv_scr_height_w = CVAR_INIT ("scr_height_w", "800", CV_SAVE, CV_Unsigned, NULL);
