...
void G_DefineDefaultControls(void)
{
	...
	for (i = 1; i < num_gamecontrolschemes; i++) // skip gcs_custom (0)
	{
		...
		gamecontroldefault[i][GC_CAMTOGGLE  ][1] = GAMEPAD_KEY(RIGHTSTICK); // Right Stick
		gamecontroldefault[i][GC_SCREENSHOT ][1] = GAMEPAD_KEY(BACK); // Back
		gamecontroldefault[i][GC_SYSTEMMENU ][0] = GAMEPAD_KEY(START); // Start
		gamecontroldefault[i][GC_VIEWPOINT  ][1] = GAMEPAD_KEY(DPAD_UP); // D-Pad Up
		gamecontroldefault[i][GC_TOSSFLAG   ][1] = GAMEPAD_KEY(DPAD_DOWN); // D-Pad Down
		...
		gamecontrolbisdefault[i][GC_CAMTOGGLE  ][1] = GAMEPAD_KEY(RIGHTSTICK); // Right Stick
		...
		gamecontrolbisdefault[i][GC_VIEWPOINT  ][1] = GAMEPAD_KEY(DPAD_UP); // D-Pad Up
		gamecontrolbisdefault[i][GC_TOSSFLAG   ][1] = GAMEPAD_KEY(DPAD_DOWN); // D-Pad Down
